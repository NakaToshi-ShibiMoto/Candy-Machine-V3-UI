       ...
       <NftsModal
        ...
        <Root>
          ...
          <StyledContainer>
            ...
            <div
              style={{  boxShadow: "6px 4px 8px #C20FF7", padding: "15px",   border: "10px double rebeccapurple",  outline:  "5px solid black", borderRadius: "1em", display: "flex", flexDirection: "column", margin: "25px", gap: "35px", justifyContent: "center",   alignContent: "stretch" }}
            >
